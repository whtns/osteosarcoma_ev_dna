...
fls <- dir("/media/thor/storage/os_exosome_pipeline/output/picard/", "_sorted.bam$", full.names = TRUE)
coldata_all <- dir("~/os_exosome_pipeline/output/dedupe_output/picard/", "_sorted.bam$")
...
report <- DESeq2Report(dds_all_cleaned, res = res_all_cleaned, 'DESeq2-all_cleaned_OS_v_ctrl', 'condition_all_cleaned',
                       outdir = 'DESeq2Report_all_cleaned', 
